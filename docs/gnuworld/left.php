...
<a href="xcmds.txt" target="right"><b>All X Commands</b></a><br><br>
...
<A HREF="<?=CSERVICE_SITE_URL?>" target=_top>Live Java Chat</a><br><br>
<? } ?>
...
?>
	...
	<? if ($admin>0 || acl(XLOGGING_VIEW)) { //minimum required admin level ?>
		<a href="viewlogs.php" target=right>View Logs</a><br><br>
	<? } else { echo "<br>"; } ?>
<?
		if ($is_alumni) {
